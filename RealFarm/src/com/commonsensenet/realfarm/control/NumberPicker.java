...
public class NumberPicker extends LinearLayout implements OnClickListener, OnLongClickListener, OnTouchListener {
	...
	public NumberPicker (Context c, double min, double max, double curNb, double increment, int digitNb) {
		super(c);
		
		inflate(c, R.layout.numberpicker, this);
    ...
    public void increment(double inc) {  
    	...
    	if(tmp > max) {
    		...
    		curNb = tmp;
    		if(digitNb == 0) number.setText((int)(curNb)+"");
    		else if(digitNb == 1) number.setText(Double.valueOf(oneDigit.format(curNb))+"");
    		else number.setText(Double.valueOf(twoDigits.format(curNb))+"");
    	}
