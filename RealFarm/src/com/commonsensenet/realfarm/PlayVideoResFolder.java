...
public class PlayVideoResFolder extends Activity
{
    ...
    { 
        ...
        {   
        vSource ="android.resource://com.commonsensenet.realfarm/" + R.raw.kannada; //test
    }
        if( Global.videosel == 2)
        {   
        vSource ="android.resource://com.commonsensenet.realfarm/" + R.raw.english; //test
    }
        ...
        video_back.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				 ...
				 Intent adminintent = new Intent(PlayVideoResFolder.this,videos.class);
