...
public class harvest_aggregate extends HelpEnabledActivity implements
		OnLongClickListener {
	...
	//	setContentView(R.layout.fertilizing_dialog);
		...
		ImageButton btnLike = (ImageButton) findViewById(R.id.aggr_item_harvest_like1);
		System.out.println("Fertilizer Aggregate entered");
		...
		if (v.getId() == R.id.aggr_item_harvest_like1) {
		...
		ImageButton btnLike2 = (ImageButton) findViewById(R.id.aggr_item_harvest_like2);
		System.out.println("Fertilizer Aggregate entered");
		btnLike2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
		
		if (v.getId() == R.id.aggr_item_harvest_like2) {
	...
	protected void cancelaudio() {
		...
		Intent adminintent = new Intent(harvest_aggregate.this, Homescreen.class);
