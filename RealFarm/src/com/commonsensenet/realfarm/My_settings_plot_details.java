...
public void onBackPressed() {
	...
	mp.release();
	 ...
	 Intent adminintent123 = new Intent(My_settings_plot_details.this, Homescreen.class);
	...
	//	    	final Button variety7;
	    		 ...
	    		 if(flag1 ==0 && flag2 ==0 && flag3 ==0) 
	    		    {
	    		    	 ...
	    		    	 Intent adminintent = new Intent(My_settings_plot_details.this,Homescreen.class);
 	...
 	/*	PlotImage.setOnClickListener(new View.OnClickListener() {
 			public void onClick(View v) {
 				System.out.println("in PlotImage");
 		//		gridview.setAdapter(new ImageAdapter(this));
 			//	gridview.setAdapter(new ImageAdapter(this));
 			//	Intent adminintent = new Intent(My_settings_plot_details.this, VIAggrRecommendation.class);
 			//	startActivity(adminintent);	
 			//	Dialog dlg = new Dialog(v.getContext());
 				
 				
 				 Dialog dlg = new Dialog(v.getContext());                                //Tested OK
 	        	dlg.setContentView(R.layout.plot_image);
 	        	dlg.setCancelable(true);
 	        	// parts
 	        	TextView dlgDetals = (TextView) dlg.findViewById(R.id.dlg_lbl_details);
 	        	ImageView Image1 = (ImageView) dlg.findViewById(R.id.ImageView01);
 	        	ImageView Image2 = (ImageView) dlg.findViewById(R.id.ImageView02);
 	        	ImageView Image3 = (ImageView) dlg.findViewById(R.id.ImageView25);
 	        	ImageView Image4 = (ImageView) dlg.findViewById(R.id.ImageView27);
 	...
 	/*	SoilType.setOnClickListener(new View.OnClickListener() {
 			public void onClick(View v) {
 				System.out.println("in SoilType");
 		
 				
 				 Dialog dlg = new Dialog(v.getContext());                                //Tested OK
 	        	dlg.setContentView(R.layout.soil_type);
 	        	dlg.setCancelable(true);
 	        	// parts
 	        	TextView dlgDetals = (TextView) dlg.findViewById(R.id.dlg_lbl_details);
 	        	ImageView Image1 = (ImageView) dlg.findViewById(R.id.ImageView01);
 	       ...
 	       // 	ImageView imgSeed = (ImageView) dlg.findViewById(R.id.dlg_img_seed);
 	        	// 
 	        	dlg.setTitle( "Soil Types");
 	        	
 	        	//imgAction.setImageResource( mDataProvider.getActionNameById(1).getRes() );
 	        	//imgSeed.setImageResource( mDataProvider.getSeedById(1).getRes());
 	        	//Log.d(logTag, "Seed res id: "+String.valueOf(mDataProvider.getSeedById(1).getRes()));
 	        	dlg.show();
                 }
...
//		System.out.println("User data is put to database");
	 ...
	 //Global.plotId++;
		...
		Toast.makeText(getBaseContext(), "Plot Details is put to Database"+plotImage12 +SoilType12 ,
