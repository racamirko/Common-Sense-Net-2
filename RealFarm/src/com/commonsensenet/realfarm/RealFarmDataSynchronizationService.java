...
public class RealFarmDataSynchronizationService extends BroadcastReceiver {
	...
	if((Integer.valueOf(separated1[1])==1000)|(Integer.valueOf(separated1[1])==1001)|(Integer.valueOf(separated1[1])==1002)|(Integer.valueOf(separated1[1])==1003)|(Integer.valueOf(separated1[1])==1004))	
	{
				...
				if(Integer.valueOf(message_type)==1001)
				{
					...
					mDataProvider.addPlot( Long.valueOf(separated2[0]), Long.valueOf(separated2[1]), Integer.valueOf(separated2[2]),
							separated2[4], Integer.valueOf(separated2[3]), Double.valueOf(separated2[5]), 0,
							 Integer.valueOf(separated2[6]), Integer.valueOf(separated2[7]), Long.valueOf(separated2[8]), Integer.valueOf(separated2[9]));
